...
console.log('Qual é a desculpa para não ir ao treino?');
...
switch(desculpa){
    case '1':
        ...
        break;
    case '2':
        console.log('Teininho leve demais rsrs');
        break;
    case '3':
        console.log('Vamos beber depois do treino!!');
        break;
    default:
        console.log('Essa não é uma desculpa válida. De qualquer forma, vai treinar!');
}
